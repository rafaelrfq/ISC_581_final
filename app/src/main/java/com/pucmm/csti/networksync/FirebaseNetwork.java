...
public class FirebaseNetwork {
    ...
    private static final String TAG = "PapoFirebaseNetwork";

    private static final String PATH_UPLOAD = "images/";
    private static final String URL_DOWNLOAD = String.format("gs://proyectofinal-csti-1780-4280.appspot.com/%s", PATH_UPLOAD);
    private static final long ONE_MEGABYTE = 1024 * 1024;

    private static FirebaseNetwork sInstance;

    public static FirebaseNetwork getNetworkInstance() {
        if (sInstance == null) {
