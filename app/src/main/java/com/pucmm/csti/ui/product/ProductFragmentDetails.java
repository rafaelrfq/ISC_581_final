...
public class ProductFragmentDetails extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (element.carousels != null && !element.carousels.isEmpty()) {
            ...
            FirebaseNetwork.getNetworkInstance().downloads(element.carousels, new NetResponse<List<Bitmap>>() {
                @Override
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        binding.action.setOnClickListener(v -> {
            ...
            Log.e("AddToCart", "Added product: " + element.product.getItemName() + " with a quantity of " + binding.qty.getText());

//            IntentFilter filter = new IntentFilter(ConnectivityManager.CONNECTIVITY_ACTION);
            //getContext().registerReceiver(BroadcastReceiverManager.getNetworkInstance().getReceiverBadge(), filter);
