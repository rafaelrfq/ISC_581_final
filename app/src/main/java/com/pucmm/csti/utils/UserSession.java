...
public class UserSession {
    ...
    // Cart List
    private static final List<Pair<Product, Integer>> cartList = new ArrayList<>();
...
//    }
    ...
    public List<Pair<Product, Integer>> getCartList() {
        return cartList;
    }

    public void addToCart(Product product, int quantity) {
        Pair<Product,Integer> pair = new Pair(product,quantity);
        cartList.add(pair);
    }
